...
procedure IssueEvent_$0$(evt_type: $1$$0$; machine: Machines; adr: $3$);
begin
  alias m : from_m_$0$(machine) do
  alias evt_entry: $4$$0$[m].evt do
  alias evt_index: evt_entry.event_queue_index do
...
procedure ServeRemoteEvent_$0$(cur_evt_type: $1$$0$; machine: Machines; adr: $3$);
begin
  alias m : from_m_$0$(machine) do
  alias evt_entry: $4$$0$[m].evt do
  alias pend_adr: $4$$0$[m].evt.pend_adr do
